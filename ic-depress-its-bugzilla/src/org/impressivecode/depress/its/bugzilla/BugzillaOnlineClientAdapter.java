...
import static org.impressivecode.depress.its.bugzilla.BugzillaOnlineParser.COMPONENT;
...
public class BugzillaOnlineClientAdapter {
	...
	private Map<String, Object> prepareGetBugsParameters(List<String> ids) {
		...
		if (bugzillaInstanceSupportFieldsInclusionInGet()) {
			parameters.put(INCLUDE_FIELDS, new String[] { ID, CREATED, UPDATED, STATUS, ASSIGNEE, FIX_VERSION, VERSION, REPORTER, PRIORITY, SUMMARY, LINK, RESOLUTION, COMPONENT });
		}
		return parameters;
	}
